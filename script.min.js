...
function pd(a){"complete"===zc.readyState||"interactive"===zc.readyState?(md.push(a),1==md.length&&(q.Promise?q.Promise.resolve().then(nd):window.setImmediate?setImmediate(nd):setTimeout(nd,0))):zc.addEventListener("DOMContentLoaded",a)};function qd(a){C(this,a,null,null)}y(qd,B);function rd(a,b){a=parseInt(a,10);return isNaN(a)?b:a};function sd(){return"r20200820"}var td=ed("false",!1),ud=ed("false",!1);function vd(){};function wd(a){a=void 0===a?x:a;var b=a.context||a.AMP_CONTEXT_DATA;if(!b)try{b=a.parent.context||a.parent.AMP_CONTEXT_DATA}catch(c){}try{if(b&&b.pageViewId&&b.canonicalUrl)return b}catch(c){}return null}function xd(a){return(a=a||wd())?Mc(a.master)?a.master:null:null};function yd(a,b,c){zd(a,b,void 0===c?null:c)}function zd(a,b,c){a.google_image_requests||(a.google_image_requests=[]);var d=a.document.createElement("img");if(c){var e=function(f){c&&c(f);d.removeEventListener&&d.removeEventListener("load",e,!1);d.removeEventListener&&d.removeEventListener("error",e,!1)};Dc(d,"load",e);Dc(d,"error",e)}d.src=b;a.google_image_requests.push(d)} 
...
function Bl(){var a=xd(wd(J))||J;Jg(a);if(!z("Trident")&&!z("MSIE")||0<=Db(Ob(),11)){kl();Ce(P(84));P(345)||(pk(),mk(".google.co.id")&&(Z[1]=".google.co.id"),rk());P(312)&&bl(new al(function(e){J.google_trust_token_redemption_status=e}));P(363)&&(a=fl(),null!=a&&a.then(function(e){J.google_user_agent_client_hint=e.i()}));try{Yk()}catch(e){}if(a=Pd(x))a=Se(a),a.tagSpecificState[1]||(a.tagSpecificState[1]=new Qi);vl();a=window.adsbygoogle;if(!a||!a.loaded){Dg(62)&&Al();var b= 
...
function wl(a){var b=Ud("/pagead/js/"+sd()+"/r20190131/slotcar_library.js");Ui(Ic(b)).then(function(c){null==gl&&(c.init(a),gl=c)})};pl();}).call(this);
